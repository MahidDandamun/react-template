...
import Create from '../components/modules/Routing/create';
                ...
                <>
                    <div className="flex flex-col">
                        <div className="text-gray-500 -ml-4">
                            ...
                            <ButtonUI variant="link" buttonName="Routing" size="medium" onClick={() => setCurrentPage("index")} />
                        </div>
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <ButtonUI variant="dark" buttonName="Create Routing" iconName="add" size="medium" onClick={() => setCurrentPage("create")} />
                            </div>
                        </div>
                    </div>
            ...
            {currentPage === "create" && (
                <>
                    <div className="text-gray-500 -ml-4">
                        <ButtonUI variant="link" buttonName="Manufacturing" size="medium" onClick={() => setCurrentPage("index")} />/
                        <ButtonUI variant="link" buttonName="Routing" size="medium" onClick={() => setCurrentPage("index")} />/
                        <ButtonUI variant="link" buttonName="Create Routing" size="medium" />
                    </div>
